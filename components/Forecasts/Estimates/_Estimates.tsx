	...
	if (!data.estimates.table.annual.dates) {
		return (
			<div>
				...
				<Unavailable message="No financial forecasts available for this stock" classes="min-h-[250px]" />
			</div>
		)
	}
	...
	return (
		<div>
			<div className="mb-2 flex flex-wrap items-center justify-between gap-x-2">
				<h2 className="mb-1 text-xl font-bold xs:mb-0">Financial Forecast</h2>
