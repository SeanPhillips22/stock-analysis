...
export const HeaderLoginNew = () => {
	...
	return (
		// <div className="ml-auto flex flex-row text-center lg:block lg:space-x-1 text-lg">
		<div className="ml-auto hidden text-center lg:block lg:space-x-1 text-lg">
			<LogInOut />
			<TrialOrAccount />
		</div>
	)
