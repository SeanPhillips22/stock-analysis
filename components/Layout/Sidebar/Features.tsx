...
export function Features({
	list = ['pro', 'ipoCalendar', 'stockScreener', 'marketMovers']
}: Props) {
	...
	return (
		<div className="space-y-3">
			{list.map((feature: any) => {
				if (isPro && FeaturesMap[feature].tagId === 'tag-upgr-nav-widget') {
					return null
				}
				return (
					<div
