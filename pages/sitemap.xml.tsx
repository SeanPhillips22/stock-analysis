...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
	const pages = [
		...
		'list/top-rated-dividend-stocks/',
		'list/most-employees/',
		'list/highest-revenue/',
		'list/car-company-stocks/',
		'list/semiconductor-stocks/',
		'list/pharmaceutical-stocks/',
		'list/biotech-stocks/',
		'list/bank-stocks/',
		'list/social-media-stocks/',
		'list/gaming-stocks/',
		'list/esports/',
		'list/online-gambling/',
		'list/mobile-games/',
		'stock-market-hours/',
