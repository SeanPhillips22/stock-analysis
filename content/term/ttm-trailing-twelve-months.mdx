...
<Text1Ad key="/term/ttm-trailing-twelve-months/1" mobileOnly={true} />
...
<Text2Ad key="/term/ttm-trailing-twelve-months/2" />
...
A forward dividend yield estimates what the dividend will be in the next four quarters, or simply multiplies the most recently announced quarterly dividend payment by four.

<Text3Ad key="/term/ttm-trailing-twelve-months/3" />
