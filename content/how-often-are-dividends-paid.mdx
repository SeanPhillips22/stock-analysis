...
<div className="summary">
	<strong>Bottom Line:</strong> Not all stocks pay a dividend, but those who do
	usually pay it every three months. Others pay semi-annually, annually,
...
<div className="summary">
	<strong>Bottom Line:</strong> The dividend gets paid on the payment date, but
	you need to buy the stock before the ex-dividend date to receive the payment.
</div>
...
<div className="summary">
	<strong>Bottom Line:</strong> Dividends are most commonly paid directly into
	the shareholder's brokerage account. But they can also be mailed via a check
	or turned into shares via automated dividend reinvestment programs.
</div>
...
<div className="summary">
	<strong>Bottom Line:</strong> Divide the annual dividend amount by four to
	calculate how much a stock pays per quarter. Calculate the dividend yield of
	a stock by dividing the annual amount with the stock price.
</div>
